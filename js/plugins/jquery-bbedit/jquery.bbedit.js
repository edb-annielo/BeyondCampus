/**
* Modified by Annie Lo
* New function unordered list / ordered list
**/
/*
...
(function($) {
  ...
  $.bbedit = {
	baseURL: "js/plugins/jquery-bbedit/",
    /*baseURL: null,*/
    i18n: {'default': {
      'b' : 'Bold',
      'i' : 'Italic',
  ...
  $.fn.extend({
    bbedit: function(settings) {
      this.defaults = {
        ...
        lang: 'default',
        tags: 'b,i,u,s,url,code,quote, ol, ul, li',
      ...
      return this.each(function() {
        ...
        if (settings.enableToolbar) {
		  ...
		  toolbar.find(".bbedit-ol").click(function() {
			insertTag(data, function(text) {
			  var numStr = prompt('Starting number: ', '1');
		  ...
		  toolbar.find(".bbedit-ul").click(function() {
			insertTag(data, function(text) {
			  if(text != ""){
				  var splitStr = text.split("\n").join("\n[*]");
				  return '\n[list]\n[*]' + splitStr + '\n[/list]\n';
		  ...
		  toolbar.find(".bbedit-li").click(function() {
            insertTag(data, '[*]', '');
          });
